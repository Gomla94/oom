<div class="form-group row">
    <label class="col-form-label col-md-3 col-sm-3" for="title">أسم المجموعة</label>
    <div class="col-md-9 col-sm-9">
        {!! Form::text('title', null, ['class' => 'form-control', 'id' => 'title',  'placeholder' => "أسم المجموعة", 'autofocus']) !!}
    </div>
</div>
