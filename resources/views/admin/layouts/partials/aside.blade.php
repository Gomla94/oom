      ...
      <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        <div class="menu_section">
          ...
          <ul class="nav side-menu">
            ...
            <li>
              <a><i class="fa fa-users"></i> {{ Helper::admin_trans('student_attendances') }}<span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu">
                {{-- @admincan('alerts') --}}
                <li><a href="{{ route('admin.users.students_attendances.index') }}"><i class="fa fa-bell-o"></i> {{ Helper::admin_trans('student_attendances_all') }} </a></li>
                {{-- @endadmincan --}}
                {{-- @admincan('alerts') --}}
                <li><a href="{{ route('admin.users.students_attendances.create') }}"><i class="fa fa-bell-o"></i> {{ Helper::admin_trans('student_attendances_create') }} </a></li>
                {{-- @endadmincan --}}
                {{-- @admincan('alerts') --}}
                <li><a href="{{ route('admin.users.students_attendances.create_checkout') }}"><i class="fa fa-bell-o"></i> {{ Helper::admin_trans('student_attendances_create_checkout') }} </a></li>
                {{-- @endadmincan --}}
              </ul>
            </li>

            @admincan('alerts')
            <li><a href="{{ route('admin.users.print_cards') }}"><i class="fa fa-bell-o"></i> {{ Helper::admin_trans('print_cards') }} </a></li>
            @endadmincan
