                                    ...
                                    <table id="datatable-fixed-header" class="table table-striped table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ Helper::admin_trans('payment_status') }}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="font-weight: bold;">
                                                <td>
                                                    {{ $number++ }}
                                                    {!! ! $item->viewed_status || ! $item->payment_status ? '<span class="badge badge-danger" title="لم تقم بالإتطلاع على الطلب"><i class="fa fa-warning"></i></span>' : '' !!}
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="{{ route('admin.' . $route . '.show', [$element => $item->id]) }}" class="btn btn-info" title="التفاصيل"><i class="fa fa-eye"></i></a>
                                                        {!! Form::open(
                                                        [
