<div class="form-group row">
    <label class="col-form-label col-md-3 col-sm-3" for="title">{{ Helper::admin_trans('title') }}</label>
    <div class="col-md-9 col-sm-9">
        {!! Form::text('title', null, ['class' => 'form-control', 'id' => 'title',  'placeholder' => Helper::admin_trans('title'), 'autofocus']) !!}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-9 col-sm-9">
        {!! Form::number('price', null, ['class' => 'form-control', 'id' => 'price',  'placeholder' => Helper::admin_trans('price'), 'autofocus']) !!}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-9 col-sm-9">
        {!! Form::date('start_date', isset($item) ? $item->start_date : null, ['class' => 'form-control', 'id' => 'start_date',  'placeholder' => Helper::admin_trans('start_date'), 'autofocus']) !!}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-9 col-sm-9">
        {!! Form::date('end_date', isset($item) ? $item->end_date : null, ['class' => 'form-control', 'id' => 'end_date',  'placeholder' => Helper::admin_trans('end_date'), 'autofocus']) !!}
    </div>
</div>
