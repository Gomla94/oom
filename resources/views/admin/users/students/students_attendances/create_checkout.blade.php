    ...
    <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>{{ Helper::admin_trans('create', ['el' => Helper::admin_trans($checkout_elements)]) }}</h3>
            </div>
        </div>
...
<script>
    ...
    async function StudentIdChangedHandler(event) {
        ...
        studentIdInput.setAttribute('disabled', true)
        const response = await axios.post('{{url("/dashboard/users/students_attendances/store_checkout")}}',{
