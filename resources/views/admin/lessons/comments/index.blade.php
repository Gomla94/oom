                                    ...
                                    <table id="datatable-fixed-header" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('admin.' . $route . '.show', ['lesson' => $item->lesson->id, $element => $item->id]) }}" class="btn btn-success"><i class="fa fa-share"></i></a>
                                                        {!! Form::open(
                                                        [
                                                            'route'     => ['admin.' . $route . '.destroy', $item->lesson->id, $item->id],
                                                            'method'    => 'DELETE',
                                                            'id'        => 'item-' . $item->id
                                                        ]) !!}
