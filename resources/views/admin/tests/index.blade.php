                                    ...
                                    <table id="datatable-fixed-header" class="table table-striped table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ Helper::admin_trans('lesson') }}</th>
                                                <th>{{ Helper::admin_trans('percentage') }}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="font-weight: bold;">
                                                <td>
                                                    {{ $number++ }}
                                                    @if (! $item->view_status)
                                                        <span class="badge badge-danger"><i class="fa fa-warning"></i></span>
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ url('test', [$element => $item->id]) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            @empty
