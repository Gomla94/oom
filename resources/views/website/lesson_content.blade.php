							...
							<ul class="list-unstyled">
								<li class="theme-option">
									<div class="theme-color logo-theme" style="text-align: center">
										<a href="#!" class="title-active" data-theme="logo-white ">ملفات الفيديو</a>
								...
								<div class="card-body no-padding height-9">
									<div class="collapse collapse-xs collapse-sm show chat-page" id="open-chats">
										<ul class="list-unstyled" id="inbox">
											...
											<li  @if($video->id == $video_id) class="active" @endif @if($video_id == null) class="kind" @endif>
							...
							<div class="card card-box">
								<div class="card-head">
									...
									@if($videos->provider == "youtube")
												...
												data-setup='{ "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "{{ $videos->link }}"}], "youtube": { "iv_load_policy": 0 } }'
											>
											</video>
											@elseif($videos->provider == "vimeo")
                                                <iframe style="width:100% !important" src="https://player.vimeo.com/video/{{ $videos->link }}?h=4ea1b41b0c" width="100%" height="500" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
    										@elseif($videos->provider == "stream")
                                                <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://streamable.com/e/{{ $videos->link }}" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
                                            @endif
