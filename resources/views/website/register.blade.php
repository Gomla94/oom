      ...
      <div class="row gx-lg-5 align-items-center mb-5">
        ...
        <div class="col-lg-6 mb-7 mb-lg-0 position-relative">
          ...
          <div class="card bg-glass">
            <div class="card-body px-4 py-5 px-md-5">
              <form method="post" action="{{ route('web/register') }}">
                ...
                <div class="form-outline mb-4 col-md-6">
                  ...
                  <input type="text" id="form3Example3" name="name" value="{{ old('name') }}" required  class="form-control" />
                </div>
                
                <!-- Email input -->
                <div class="form-outline mb-4 col-md-6">
                  <label class="form-label"   for="form3Example3">رقم التليفون</label>
                  <input type="number" id="form3Example3" name="phone" value="{{ old('phone') }}" required  class="form-control" />
                </div>
                <!-- Email input -->
                <div class="form-outline mb-4 col-md-6">
                  <label class="form-label"   for="form3Example3">العنوان</label>
                  <input type="text" id="form3Example3" name="address" value="{{ old('address') }}" required  class="form-control" />
                </div>
              
                <div class="form-outline mb-4 col-md-6">
                  <label class="form-label"   for="form3Example3">المجموعه</label>
                  <select class="form-control groupp" name="group_id">
                    <option selected disabled aria-readonly="" value="">املئ الصف اولاً</option>
                  </select>
                </div>
                  <!-- Email input -->
                  <div class="form-outline mb-4 col-md-6">
                    <label class="form-label"   for="form3Example3">الصف</label>
                    <select class="form-control thegrade" >
            ...
            <a class="btn btn-primary  mb-4" href="#">تسجيل جديد</a>
          </div>
