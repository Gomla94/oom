											...
											<tbody>
												...
												<tr class="odd gradeX">
													<td class="user-circle-img">
														<img width="30" src="{{ Helper::getImg($item->img) }}" alt="">
													</td>
													...
													<td class="center"><a href="{{ url('admin/'.$itemsnames.'/'. $item->id .'/edit') }}"><span class="label label-sm label-success">More </span></a></td>
													<td class="center">
