...
@section('content')
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="row">
						<div class="col-sm-12">
                        <form method="post" action="{{ url('admin/specialists/'.$specialist->id.'/meals'.'/'.$items->id.'/week/'.$id3) }}"  enctype="multipart/form-data" class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<label style="color:red"> This Meal For ( Breakfast - lunch - dinner - Snaks )</label>
											<select name="type" class="mdl-textfield__input">
												<option value="1">Breakfast</option>
												<option value="2">Lunch</option>
                                                <option value="3">Dinner</option>
                                                <option value="4">Snaks</option>
											</select>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
