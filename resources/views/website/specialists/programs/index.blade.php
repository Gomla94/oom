								...
								<div class="card-body ">
									<div class="row p-b-20">
										<div class="col-md-6 col-sm-6 col-6">
											<div class="btn-group">
                                            <a href="{{ url('admin/specialists/'.$specialist->id.'/program/create') }}" id="addRow" class="btn btn-info">
										...
										<table class="table table-hover table-checkable order-column full-width"
											...
											<thead>
												<tr>
													...
													<th class="center"> Title English  </th>
													<th class="center"> Title Arabic  </th>
											...
											<tbody>
												...
												<tr class="odd gradeX">
													...
													<td class="center">{{ $item->title_ar }}</td>
													<td class="center"><a href="{{ url('admin/specialists/'.$specialist->id.'/program'.'/'.$item->id.'/edit') }}"><span class="label label-sm label-success">Edit </span></a></td>
													<td class="center">
                                                   {{--  <a href="{{ url('admin/'.$itemsnames.'/'. $item->id .'/edit') }}" class="btn btn-tbl-edit btn-xs">
															<i class="fa fa-pencil"></i>
                                                        </a> --}}
                                                        <form method="post" action="{{ url('admin/specialists/'.$specialist->id.'/program'.'/'.$item->id) }}">
