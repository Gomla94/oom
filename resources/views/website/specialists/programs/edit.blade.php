...
@section('content')
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="row">
						<div class="col-sm-12">
                        <form method="post" action="{{ url('admin/specialists/'.$specialist->id.'/program'.'/'.$items->id) }}"  enctype="multipart/form-data" class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<label class="mdl-textfield__label">Description English</label>
										</div>
                                    </div>
									<div class="col-lg-6 p-t-20">
										<div
											...
											<label class="mdl-textfield__label">Description Arabic</label>
										</div>
                                    </div>
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<textarea name="things_not_en" class="mdl-textfield__input" >{{ $items->things_not_en }}</textarea>
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<textarea name="things_not_ar" class="mdl-textfield__input" >{{ $items->things_not_ar }}</textarea>
									...
									<div class="col-lg-12 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input type="text" name="price" class="mdl-textfield__input" value="{{ $items->price }}">
