											...
											<tbody>
												...
												<tr class="odd gradeX">
													...
													<td class="user-circle-img">
                                                    	<img width="80" src="{{ Helper::getImg($item->user->img) }}" alt="user-img">
													</td>
													<td class="center">{{ $item->user->name }}</td>
													<td class="center">{{ $item->user->email }}</td>
													<td class="center">{{ $item->mobile }}</td>
													<td class="center">{{ $item->subject }}</td>
													<td class="center"><a href="{{ url('admin/'.$itemsnames.'/'. $item->id .'/edit') }}"><span class="label label-sm label-success">View </span></a></td>
													<td class="center">
                                                   {{--  <a href="{{ url('admin/'.$itemsnames.'/'. $item->id .'/edit') }}" class="btn btn-tbl-edit btn-xs">
															<i class="fa fa-pencil"></i>
                                                        </a> --}}
                                                        
														<a href="{{ url('admin/technical/delete/'.$item->id) }}">
