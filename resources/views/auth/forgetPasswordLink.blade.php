...
<html lang="en">
  <head>
    ...
    <title>Noor App | Dashboard</title>
...
body {
    background: linear-gradient(-90deg, #292425, #77cfe5, #23a6d5, #025872);
    ...
    <div class="myforma">
      ...
      <div class="login_wrapper">
        ...
        <div class="animate form login_form">
            <img class="logoForm" src="{{ $admin_temp }}/images/logo.png">
          <section class="login_content">
            ...
            [
              ...
              <h1 class="hed">أسترجاع كلمة السر</h1>
              ...
              <div>
               ...
               <div>
                  {!! Form::password('password_confirmation', ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'password_confirmation ..']) !!}
              </div>
              <div>
                <button class="btn btn-primary btn-block submit" type="submit">إعادة التعيين</button>
              </div>
              ...
              <div class="separator">
                ...
                <div>
                  <h1 style="text-shadow: none;color:#fff">Noor Application</h1>
