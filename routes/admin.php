...
// this route is what will be sent to parent in the sms.
Route::get('students/{student}/attendances', 'Admin\Users\StudentsController@get_attendances')->name('student.attendances');
...
Route::namespace('Admin')->group(function ()
{
    ...
    Route::group(['middleware' => 'admin'], function ()
    {
        ...
        Route::group(['prefix' => 'users', 'namespace' => 'Users', 'as' => 'users.'], function ()
        {
            ...
            Route::get('student_card/{student}', 'StudentsController@get_qrcode')->name('students.qrcode');
            Route::resource('students_attendances', 'StudentsAttendanceController');
            Route::get('students_attendances_create_checkout', 'StudentsAttendanceController@create_checkout')->name('students_attendances.create_checkout');
            Route::post('students_attendances/store_checkout', 'StudentsAttendanceController@store_checkout');
            Route::get('students_attendances/weekly_report/{id}', 'StudentsAttendanceController@weekly_report')->name('students.weekly_reports');
            Route::get('print_students_cards', 'StudentsController@print_cards')->name('print_cards');
        ...
        Route::get('groups/{group}/attendances', 'GroupsController@attendances')->name('groups.attendances');
