                                ...
                                <div class="card-box table-responsive">
                                    <table id="datatable-fixed-header" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                                $status = $item->messages()->where('admin_view', 0)->select('admin_view')->where('chat_id' , $item->id)->first();
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    {{ $item->student->name }}
                                                    @if($status != null)<span class="badge badge-danger" title="غير مقروء"><i class="fa fa-warning"></i></span>@endif
                                                </td>
                                                <td>
                                                    <div class="btn-group">
