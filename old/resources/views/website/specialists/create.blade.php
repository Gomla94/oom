                   ...
                   @include('admin.error')
					<div class="row">
						<div class="col-sm-12">
                            ...
                            <form method="POST" action="{{ url('admin/'.$itemsnames) }}"  enctype="multipart/form-data" class="card-body row">
                                @csrf
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="password" class="mdl-textfield__input" type="password"
                                    ...
                                    <div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="password" name="password_confirmation"
												 id="password-confirm">
											<label class="mdl-textfield__label" for="text5">Password Confirmation</label>
										</div>
                                    </div>
                                    <div class="col-lg-6 p-t-20">
										<div
