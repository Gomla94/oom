                   ...
                   @include('admin.error')
					<div class="row">
						<div class="col-sm-12">
                            ...
                            <form method="POST" action="{{ url('admin/specialists/'. $specialist->id .'/program') }}" class="card-body row"  enctype="multipart/form-data">
								@csrf
							<input type="hidden" value="{{ $specialist->id }}" name="specialist_id">
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input type="text" name="title_en" class="mdl-textfield__input"  >
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input type="text" name="title_ar" class="mdl-textfield__input" >
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<textarea name="text_en" class="mdl-textfield__input" ></textarea>
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<textarea name="text_ar" class="mdl-textfield__input" ></textarea>
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<textarea name="things_not_en" class="mdl-textfield__input" ></textarea>
											<label class="mdl-textfield__label">Things are forbidden with this system English</label>
										</div>
                                    </div>
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<textarea name="things_not_ar" class="mdl-textfield__input" ></textarea>
											<label class="mdl-textfield__label">Things are forbidden with this system Arabic</label>
										</div>
                                    </div>
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input type="text" name="price" class="mdl-textfield__input" >
