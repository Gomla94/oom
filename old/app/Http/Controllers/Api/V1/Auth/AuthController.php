       ...
       if(is_null($device))
        {
            ...
            Auth::logout();
            return $this->error("هذا الجهاز غير مسجل لدينا , برجاء الرجوع للإدراة لتفعيل الجهاز");
        }

        if(! $device->status)
        {
            Auth::logout();
            return $this->error("لا يمكنك تسجيل الدخول من هذا الجهاز , يمكنك الرجوع للإدارة لتفعيل الجهاز");
        }
