...
class LessonsController extends Controller
{
    ...
    public function show($month_id, $lesson_id, $video_id = null)
    {
        ...
        $videos       = Video::where('lesson_id', $lesson_id)->paginate(1);
        $comments     = Comment::where('video_id', $video_id)->with('replies')->get();
        
        return view('website.lesson_content', compact('item', 'videos', 'videosPages', 'month_id', 'lesson_id', 'comments', 'video_id'))->with($this->data);
    }
    ...
    public function pdf($month_id, $lesson_id)
    {
        ...
        return view('website.lesson_content_pdf', compact('item', 'items'))->with($this->data);
    ...
    public function questions($month_id, $lesson_id)
    {
        ...
        return view('website.lesson_quest', compact('questions', 'month_id', 'lesson_id'))->with($this->data);
